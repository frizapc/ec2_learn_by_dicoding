...
exports.up = (pgm) => {
  ...
  pgm.sql("UPDATE notesdb SET owner = 'old_notes' WHERE owner IS NULL");

  // memberikan constraint foreign key pada owner terhadap kolom id dari tabel users
  pgm.addConstraint(
    'notesdb',
    'fk_notesdb.owner_users.id',
...
exports.down = (pgm) => {
  ...
  pgm.dropConstraint('notesdb', 'fk_notesdb.owner_users.id');

  // mengubah nilai owner old_notes pada note menjadi NULL
  pgm.sql("UPDATE notesdb SET owner = NULL WHERE owner = 'old_notes'");
